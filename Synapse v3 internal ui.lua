...
ReGui:DefineTheme("Synapse X Theme", {
	...
	ButtonsBg = Color3.fromRGB(150, 80,40),
...
local ScriptTab = Window:CreateTab({ Name = "Synapse X" })
...
Editor:SetText("print('Synapse X by rty! Discord:https://discord.gg/3PwAy6Zy2D')")
